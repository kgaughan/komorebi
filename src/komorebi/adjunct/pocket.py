...
class Actions:
    ...
    def favorite(self, item_id: str) -> None:
    ...
    def tags_add(self, item_id: str, tags: t.Sequence[str]) -> None:
        self._append(action="tags_add", item_id=item_id, tags=tags)

    def tags_remove(self, item_id: str, tags: t.Sequence[str]) -> None:
        self._append(action="tags_remove", item_id=item_id, tags=tags)

    def tags_replace(self, item_id: str, tags: t.Sequence[str]) -> None:
        self._append(action="tags_replace", item_id=item_id, tags=tags)

    def tags_clear(self, item_id: str) -> None:
        self._append(action="tags_clear", item_id=item_id)

    def tag_rename(self, old_tag: str, new_tag: str) -> None:
...
class Client:
    ...
    def __init__(self, consumer_key: str, access_token: str | None = None) -> None:
        super().__init__()
        self._consumer_key = consumer_key
        self.access_token = access_token

    def make_request(self, method: str, params: dict | None = None):
    ...
    def oauth_request(self, redirect_uri: str, state: str | None = None):
